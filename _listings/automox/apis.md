...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/automox/apis.md
specificationVersion: "0.14"
apis:
- name: Automox API - Get Software Version
  x-api-slug: software-version-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/automox/software-version-get-openapi.md
- name: Automox API - Get Software Version
  x-api-slug: software-version-get
  description: Retrieves software packages and patches for an organization, specific
    policy, or just those that need [approval | attention | exceptions | pending update].
