...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/aws-identity-and-access-management/apis.md
...
- name: AWS Identity and Access Management API List Policy Versions
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/aws-identity-and-access-management/actionlistpolicyversions-get-openapi.md
- name: AWS Identity and Access Management API Set Default Policy Version
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/aws-identity-and-access-management/actionsetdefaultpolicyversion-get-openapi.md
- name: AWS Identity and Access Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/aws-identity-and-access-management/openapi.md
x-common:
- type: x-change-log
