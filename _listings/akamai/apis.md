...
- name: Akamai API Update a Cloudlets Origin Version
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/akamai/cloudlets-api-v2-origins-originid-versions-version-put.md
x-common:
- type: x-base
