...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/versions/master/_listings/akamai/cloudlets-api-v2-policies-policyid-versions-matchruleformat,cloneversion-post.md
x-common:
- type: x-base
