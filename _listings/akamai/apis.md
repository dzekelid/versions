...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/akamai/cloudlets-api-v2-policies-policyid-versions-version-omitrules,matchruleformat-get.md
x-common:
- type: x-base
