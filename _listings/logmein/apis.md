...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/logmein/apis.md
...
- name: GoToWebinar API - Create Registrant (Version 2)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/logmein/organizerkeywebinarswebinarkeyregistrants-post-openapi.md
- name: GoToWebinar API - Create Registrant (Version 2)
  x-api-slug: organizerkeywebinarswebinarkeyregistrants-post
  description: Create registrant (version 2).
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28873-www-logmeininc-com.jpg
