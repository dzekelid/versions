...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/aws-rds/apis.md
...
- name: AWS RDS API - Describe D B Engine Versions
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/versions/master/_listings/aws-rds/actiondescribedbengineversions-get-openapi.md
- name: AWS RDS API - Describe D B Engine Versions
  x-api-slug: actiondescribedbengineversions-get
  description: Returns a list of the available DB engines.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Database_AmazonRDS.png
